namespace mdns_api.Models {
    public class Clan {
        ...
        public string Background { get; set; } = "https://dummyimage.com/560x300/aaa/ffffff.jpg&text=No+Background";
        public List<ClanMember> Members { get; set; } = new();
        public List<string> Cars { get; set; } = new();
        public List<string> Stages { get; set; } = new();
        public ClanWebpresence Webpresence { get; set; } = new();
    }
